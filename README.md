...
```bash
npm test          # runs all thirteen simulator suites plus the plugin-integrity check
# or individually:
...
Requires Node ≥ 18 (developed on Node 22). Current status: **356 passing** (12 + 44 + 47 + 21 + 17 + 24 + 19 + 29 + 18 + 52 + 26 + 20 + 23 + 4), 0 failing.
